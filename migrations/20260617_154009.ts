...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "realisations_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "contact" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"cta_title" varchar DEFAULT 'Parlons de votre projet.',
  ...
  ALTER TABLE "realisations_gallery" ADD CONSTRAINT "realisations_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "realisations_gallery" ADD CONSTRAINT "realisations_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."realisations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "realisations" ADD CONSTRAINT "realisations_cover_image_id_media_id_fk" FOREIGN KEY ("cover_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "realisations_gallery_order_idx" ON "realisations_gallery" USING btree ("_order");
  CREATE INDEX "realisations_gallery_parent_id_idx" ON "realisations_gallery" USING btree ("_parent_id");
  CREATE INDEX "realisations_gallery_image_idx" ON "realisations_gallery" USING btree ("image_id");
  CREATE INDEX "realisations_cover_image_idx" ON "realisations" USING btree ("cover_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "realisations_gallery" CASCADE;
